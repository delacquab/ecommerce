  ...
  renderDadosDoCliente() {
    ...
    return (
      <div className="flex-2">
        ...
        <TextoDados
          chave="Telefone"
          valor={cliente ? cliente.telefones[0] : ""}
        />
        <TextoDados
          chave="Data de Nascimento"
          valor={
            cliente ? moment(cliente.dataDeNascimento).format("DD/MM/YYYY") : ""
          }
        />
      </div>
    );
  ...
  renderDadosDeEntrega() {
    ...
    return (
      <div className="flex-2">
        ...
        <TextoDados
          chave="Endereço"
          valor={entrega ? entrega.endereco.local : ""}
        />
        <TextoDados
          chave="Numero"
          valor={entrega ? entrega.endereco.numero : ""}
        />
        <TextoDados
          chave="Bairro"
          valor={entrega ? entrega.endereco.bairro : ""}
        />
        <TextoDados
          chave="Cidade"
          valor={entrega ? entrega.endereco.cidade : ""}
        />
        <TextoDados
          chave="Estado"
          valor={entrega ? entrega.endereco.estado : ""}
        />
